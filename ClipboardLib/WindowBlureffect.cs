...
public class WindowBlureffect
{
    ...
    public WindowBlureffect(IntPtr intPtr, AccentState accentState)
    {
        this.accentState = accentState;
        EnableBlur(intPtr);
    }
    ...
    public void EnableBlur(IntPtr intPtr)
    {
        ...
        data.Data = accentPtr;
        SetWindowCompositionAttribute(intPtr, ref data);
    ...
    private void EnableBlur()
    {
        ...
        EnableBlur(windowHelper.Handle);
    }
}
